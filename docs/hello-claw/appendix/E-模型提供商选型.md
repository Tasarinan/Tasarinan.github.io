...
prev:
  text: '附录 D：技能开发与发布指南'
  link: '/hello-claw/appendix/D-技能开发与发布'
next:
  text: '附录 F：命令速查表'
  link: '/hello-claw/appendix/F-命令速查表'
---
...
- Kimi Claw 托管服务（见[附录 C](/hello-claw/appendix/C-方案对比与选型)）
...
- ArkClaw 全托管服务深度集成（见[附录 C](/hello-claw/appendix/C-方案对比与选型)）
...
- 腾讯云部署深度集成（见[附录 C](/hello-claw/appendix/C-方案对比与选型)）
- QQ/企微/微信生态协同
- 支持函数调用
...
- MaxClaw 全托管服务（见[附录 C](/hello-claw/appendix/C-方案对比与选型)）
- 200K+ 长上下文
...
- 有免费体验额度
- 与百度云部署方案集成（见[附录 C](/hello-claw/appendix/C-方案对比与选型)）
...
![大模型排行榜——业内公认的模型能力梯队示意](/hello-claw/appendix/images/model-ranking.jpg)
