...
prev:
  ...
  link: '/hello-claw/appendix/C-方案对比与选型'
next:
  text: '附录 E：模型提供商选型指南'
...
![ClawHub 技能发布界面](/hello-claw/appendix/images/clawhub-publish-skill.png)
...
如需在配置文件中精细控制技能启用/禁用，详见[附录 G 配置文件详解](/hello-claw/appendix/G-配置文件详解)。
