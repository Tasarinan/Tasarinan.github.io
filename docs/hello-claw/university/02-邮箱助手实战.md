...
![IMAP 与 POP3 的差异](/hello-claw/university/images/email-assistant/imap-vs-pop3-differences.png)
...
![网易 163 邮箱登录页](/hello-claw/university/images/email-assistant/163-login-page.png)

登录完成后，你会进入 163 邮箱主页。

![网易 163 邮箱主页](/hello-claw/university/images/email-assistant/163-webmail-home.png)
...
![163 设置页中的 POP3/SMTP/IMAP 入口](/hello-claw/university/images/email-assistant/163-settings-pop3-smtp-imap-menu.png)
...
![开启 IMAP/SMTP 前的确认弹窗](/hello-claw/university/images/email-assistant/163-imap-smtp-enable-confirm.png)

完成页面要求的验证后，会看到开启成功的提示：

![IMAP/SMTP 开启成功提示](/hello-claw/university/images/email-assistant/163-imap-smtp-enable-success.png)

如果你后面还要兼容某些历史设备、旧系统，或者沿用既有的 `POP3` 收信流程，也可以额外开启 `POP3/SMTP`。  
对应的成功提示长这样：

![POP3/SMTP 开启成功提示](/hello-claw/university/images/email-assistant/163-pop3-smtp-enable-success.png)
...
![163 邮箱授权码管理区域](/hello-claw/university/images/email-assistant/163-authorization-code-management.png)

如果你这里已经有旧授权码记录，先处理掉不再使用的旧记录，再重新生成新的授权码会更稳。

如果你点击新增或重新生成，页面会弹出授权码窗口。这里展示的这串字符，就是后面第三方客户端或 Python 脚本要使用的登录凭证。

![163 邮箱授权码弹窗](/hello-claw/university/images/email-assistant/163-authorization-code-dialog.png)
...
![163 邮箱协议服务器地址说明](/hello-claw/university/images/email-assistant/163-mail-server-endpoints.png)
