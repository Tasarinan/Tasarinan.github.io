...
![HiClaw 任务流转图](/hello-claw/university/images/multi-claw-hiclaw/task-lifecycle.svg)
...
![HiClaw 安全边界图](/hello-claw/university/images/multi-claw-hiclaw/security-boundary.svg)
...
![HiClaw 协作总览图](/hello-claw/university/images/multi-claw-hiclaw/hiclaw-overview.svg)
...
![Element Web 首页](/hello-claw/university/images/multi-claw-hiclaw/element-web-home.png)
...
![Admin Room](/hello-claw/university/images/multi-claw-hiclaw/admin-room.png)
...
![Manager 欢迎消息](/hello-claw/university/images/multi-claw-hiclaw/manager-welcome.png)

Manager 一般会说明自己负责分配任务、跟进进度、处理卡点、唤醒对应 Worker 等工作。继续往下对话时，你还会看到更具体的说明界面：

![Manager 对话](/hello-claw/university/images/multi-claw-hiclaw/manager-conversation.png)
...
![Worker 创建完成详情](/hello-claw/university/images/multi-claw-hiclaw/worker-created-detail.png)

你通常会在这里看到 Worker 名称、角色、已配置能力，以及账号注册、房间创建、权限配置、容器启动这些步骤是否完成。

过一会后，你会收到 Worker 房间邀请：

![Worker 房间邀请](/hello-claw/university/images/multi-claw-hiclaw/worker-room-invite.png)
...
![Worker 创建进度](/hello-claw/university/images/multi-claw-hiclaw/worker-creation-progress.png)
...
![邀请加入 Worker 房间](/hello-claw/university/images/multi-claw-hiclaw/invite-to-worker-room.png)
...
![Worker Alice 对话](/hello-claw/university/images/multi-claw-hiclaw/worker-alice-conversation.png)
