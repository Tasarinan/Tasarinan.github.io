...
prev:
  ...
  link: '/hello-claw/adopt/01-AutoClaw一键安装'
next:
  text: '第3章 初始配置向导'
  link: '/hello-claw/adopt/03-初始配置向导'
---
...
> **想跳过这些？** [第一章](/hello-claw/adopt/01-AutoClaw一键安装)介绍了 **AutoClaw**——下载 → 双击 → 注册即用，内置模型和免费额度，无需终端操作。
...
更多云部署方案见[附录 C 类 Claw 方案对比与选型](/hello-claw/appendix/C-方案对比与选型)。
...
![Windows PowerShell 终端](/hello-claw/adopt/images/chapter2/windows-powershell.png)
...
![openclaw --version 终端输出](/hello-claw/adopt/images/chapter2/openclaw-version.png)
...
![openclaw onboard 配置向导界面](/hello-claw/adopt/images/chapter2/openclaw-onboard.png)
...
![OpenRouter 注册页面](/hello-claw/adopt/images/chapter2/openrouter-signup.png)
...
![OpenRouter API Key 创建页面](/hello-claw/adopt/images/chapter2/openrouter-token.png)
...
![OpenRouter 充值页面](/hello-claw/adopt/images/chapter2/openrouter-credits.png)
...
![硅基流动注册页面](/hello-claw/adopt/images/chapter2/siliconflow-register.png)

![API 密钥创建页面](/hello-claw/adopt/images/chapter2/siliconflow-api-key.png)
...
> **更多提供商**：OpenClaw 支持 15+ 模型提供商（DeepSeek、Qwen、Kimi、GLM、OpenAI、Claude 等），完整列表及获取地址见[附录 E 模型提供商选型指南](/hello-claw/appendix/E-模型提供商选型)。

> **想了解配置文件结构？** 向导会自动生成配置文件，通常无需手动修改。如需了解每个字段的含义，详见[附录 G 配置文件详解](/hello-claw/appendix/G-配置文件详解)。
...
![openclaw status 输出](/hello-claw/adopt/images/chapter2/openclaw-status.png)
...
![Web 控制面板浏览器界面](/hello-claw/adopt/images/chapter2/openclaw-dashboard-browser.png)

> **什么是 localhost？** `localhost` 就是"本机"的意思，这个网页只有你自己能打开。

> 更多命令见[附录 F 命令速查表](/hello-claw/appendix/F-命令速查表)。
