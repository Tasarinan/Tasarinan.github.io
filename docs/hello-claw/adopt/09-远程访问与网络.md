...
> **前置条件**：已完成[第八章 网关运维](/hello-claw/adopt/08-网关运维)，Gateway 正常运行。
...
![云服务器 24 小时在线部署架构：Gateway 部署在 VPS 上，笔记本通过 SSH 隧道远程连接](/hello-claw/adopt/images/chapter9/OpenClaw云服务器.png)
