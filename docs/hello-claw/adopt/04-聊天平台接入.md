...
> **AutoClaw 用户**：飞书扫码即完成接入，[可跳过本章](/hello-claw/adopt/01-AutoClaw一键安装)。
...
- 已完成 [第二章](/hello-claw/adopt/02-OpenClaw快速安装) 的安装（`openclaw status` 显示正常）
...
![飞书开放平台首页](/hello-claw/adopt/images/chapter4/lark.png)
...
![飞书应用凭证页面](/hello-claw/adopt/images/chapter4/lark-credential.png)

### 第四步：启用机器人能力

进入"添加应用能力" → "机器人"，点击"添加"。

![添加应用能力页面](/hello-claw/adopt/images/chapter4/lark-app.png)
...
![飞书权限管理页面](/hello-claw/adopt/images/chapter4/lark-authentication.png)
...
![版本管理与发布页面](/hello-claw/adopt/images/chapter4/lark-version.png)
...
![事件与回调页面](/hello-claw/adopt/images/chapter4/lark-event.png)
...
![飞书配对码提示界面](/hello-claw/adopt/images/chapter4/lark-pairing.jpg)
...
![应用审核页面](/hello-claw/adopt/images/chapter4/lark-review.png)

**配置修改后不生效？**

`openclaw gateway restart`。更多配置项见[附录 G](/hello-claw/appendix/G-配置文件详解)。
