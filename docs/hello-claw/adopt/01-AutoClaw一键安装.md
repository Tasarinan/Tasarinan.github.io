...
prev:
  text: '写在开头'
  link: '/hello-claw/adopt/00-intro'
next:
  text: '第2章 OpenClaw 手动安装'
  link: '/hello-claw/adopt/02-OpenClaw快速安装'
---
...
![AutoClaw 初始界面](/hello-claw/adopt/images/chapter1/autoclaw.png)
...
![Quick Setup](/hello-claw/adopt/images/chapter1/autoclaw-agent-quick-setup.png)
...
![头像风格设置](/hello-claw/adopt/images/chapter1/autoclaw-avatar.png)
...
更多聊天平台详见[第四章](/hello-claw/adopt/04-聊天平台接入)。
...
![Preferences 设置页面](/hello-claw/adopt/images/chapter1/autoclaw_preferences.png)
...
支持通过 **Extra Skill Directories** 添加额外的技能目录。想自己编写技能？详见[附录 D：技能开发与发布指南](/hello-claw/appendix/D-技能开发与发布)。
