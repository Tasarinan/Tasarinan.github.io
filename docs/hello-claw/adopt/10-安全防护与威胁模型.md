...
> **前置条件**：已完成[第八章 网关运维](/hello-claw/adopt/08-网关运维)，Gateway 已安装并运行。
...
> 沙盒的详细配置（Docker 隔离、工具策略、提权模式）请参考[第八章第 6 节](/hello-claw/adopt/08-网关运维)。
...
- 如果需要远程访问，使用 SSH 隧道或 Tailscale（详见[第九章](/hello-claw/adopt/09-远程访问与网络)）
...
![OpenClaw三层隔离方案](/hello-claw/adopt/images/chapter10/OpenClaw三层隔离方案.png)
...
![OpenClaw 信任边界架构](/hello-claw/adopt/images/chapter10/OpenClaw信任边界架构.png)
