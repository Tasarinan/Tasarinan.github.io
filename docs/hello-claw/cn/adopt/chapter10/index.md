...
> **前置条件**：已完成[第八章 网关运维](/hello-claw/cn/adopt/chapter8/)，Gateway 已安装并运行。
...
> 沙盒的详细配置（Docker 隔离、工具策略、提权模式）请参考[第八章第 6 节](/hello-claw/cn/adopt/chapter8/)。
...
- 如果需要远程访问，使用 SSH 隧道或 Tailscale（详见[第九章](/hello-claw/cn/adopt/chapter9/)）
