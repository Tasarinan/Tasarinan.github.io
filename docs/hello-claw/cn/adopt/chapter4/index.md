...
> **AutoClaw 用户**：飞书扫码即完成接入，[可跳过本章](/hello-claw/cn/adopt/chapter1/)。
...
- 已完成 [第二章](/hello-claw/cn/adopt/chapter2/) 的安装（`openclaw status` 显示正常）
...
`openclaw gateway restart`。更多配置项见[附录 G](/hello-claw/cn/appendix/appendix-g)。
