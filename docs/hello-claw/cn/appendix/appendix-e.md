...
prev:
  text: '附录 D：技能开发与发布指南'
  link: '/hello-claw/cn/appendix/appendix-d'
next:
  text: '附录 F：命令速查表'
...
- Kimi Claw 托管服务（见[附录 C](/hello-claw/cn/appendix/appendix-c)）
...
- ArkClaw 全托管服务深度集成（见[附录 C](/hello-claw/cn/appendix/appendix-c)）
...
- 腾讯云部署深度集成（见[附录 C](/hello-claw/cn/appendix/appendix-c)）
- QQ/企微/微信生态协同
- 支持函数调用
...
- MaxClaw 全托管服务（见[附录 C](/hello-claw/cn/appendix/appendix-c)）
- 200K+ 长上下文
...
- 有免费体验额度
- 与百度云部署方案集成（见[附录 C](/hello-claw/cn/appendix/appendix-c)）
