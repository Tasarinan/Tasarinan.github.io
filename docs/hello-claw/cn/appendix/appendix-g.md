...
prev:
  text: '附录 F：命令速查表'
  link: '/hello-claw/cn/appendix/appendix-f'
next: false
---
...
> 渠道配置详见[第 4 章 Chat Provider 配置](/hello-claw/cn/adopt/chapter4/)。
...
> 网关管理详见[第 8 章](/hello-claw/cn/adopt/chapter8/)，远程访问详见[第 9 章](/hello-claw/cn/adopt/chapter9/)。
...
> 技能管理用 `clawhub` CLI，详见[附录 D 技能开发与发布指南](/hello-claw/cn/appendix/appendix-d)。
...
> 定时任务的增删改查见[附录 F 命令速查表](/hello-claw/cn/appendix/appendix-f#定时任务)。
