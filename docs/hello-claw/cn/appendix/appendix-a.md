...
prev:
  ...
  link: '/hello-claw/cn/adopt/chapter11'
next:
  text: '附录 B：社区之声与生态展望'
  link: '/hello-claw/cn/appendix/appendix-b'
---
...
> 详见[第一章 AutoClaw 一键安装](/hello-claw/cn/adopt/chapter1/)。
...
> 详见[附录 F：云服务部署指南](/hello-claw/cn/appendix/appendix-f)。
...
> 详见[第二章 OpenClaw 手动安装](/hello-claw/cn/adopt/chapter2/)。
...
> 详见[第五章 模型管理](/hello-claw/cn/adopt/chapter5/)。
...
> 详见[第四章 Chat Provider 配置](/hello-claw/cn/adopt/chapter4/)。
...
> 详见[附录 D：技能开发模板](/hello-claw/cn/appendix/appendix-d)。
...
> 详见[第十章 安全防护与威胁模型](/hello-claw/cn/adopt/chapter10/)。
...
> 详见[第十一章 Web 界面与客户端](/hello-claw/cn/adopt/chapter11/)。
